function [x,f,funEvals] = minConf_PQN(funObj,x,funProj,options,ckpntFun)
...
[verbose,numDiff,optTol,progTol,maxIter,maxProject,suffDec,corrections,adjustStep,bbInit,...
    ...
    myProcessOptions(...
    options,'verbose',3,'numDiff',0,'optTol',1e-5,'progTol',1e-9,'maxIter',100,'maxProject',100000,'suffDec',1e-4,...
